* First use `video_face_detector_save_tool.py` to extract faces from videos frame by frame and store them as images in a folder named as the video file name.
