...
def gameLoop():
  ...
  if crct == 0:
      ...
      mean_time=(t/crct)     # For actual mean time it should be divided by 10 (which is a const), but here we are dividing by no. of crct to increase the value of this ratio if crct is less
  gameDisplay.fill(white)
 ...
 # pygame.time.delay(5000)
  ...
  for counter in range(1,11):
      ...
      #print("time",t_1)
  #incorrect_1=total_crct_1 - crct_1+incrt_1      # I think incrt_1 itself has count of all types of incorrect responses
  incorrect_1 = incrt_1 
  if crct_1 == 0:
      mean_time_1 = 0
